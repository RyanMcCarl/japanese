...
def get_data(kanji_dict={}):
    kanjidic2 = read_json("Japanese/kanji/archive/kanjidic2.json")
    # For testing:
...
def collect_kanji_tags(kanji_dict={}):
    # Kanji in context
                                                                                                    ...
                                                                                                    with open('/home/ryan/wbtools/Japanese/kanji/data/reference/possible_kanji.txt', mode='r', encoding='utf-8') as infile:
...
def write_kanji_files(kanji_list, kanji_dict):
    write_files(entry_type='kanji', dict_data=kanji_dict, errors=[])
    write_json(dict_data=kanji_list, outfile="output/kanji.json", errors=[])
